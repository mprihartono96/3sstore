            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="gambar_awal" alt />
                </div>
                <div class="product-thumbs">
                  <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                    <div
                      ...
                      :class="thumbs[0] == gambar_awal ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[1] == gambar_awal ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[2] == gambar_awal ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[3] == gambar_awal ? 'active' : ''"
                    >
              ...
              <div class="col-lg-6">
                <div class="product-details text-left">
                  ...
                  <div class="quantity">
                    <router-link to="/cart">
                      <a class="primary-btn pd-cart">Add To Cart</a>
                    </router-link>
                  </div>
                </div>
              </div>
...
<script>
// @ is an alias to /src
import Header3SStore from "@/components/Header3SStore.vue";
import Footer3SStore from "@/components/Footer3SStore.vue";
import Related3SStore from "@/components/Related3SStore.vue";
